...
try:
    ...
    _import_structure["pipeline_stable_diffusion_xl_diffusion_particle"] = ["StableDiffusionXLParticlePipeline"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_stable_diffusion_xl_diffusion_particle import StableDiffusionXLParticlePipeline
